...
\usepackage{amsfonts}
\usepackage{graphicx}
\usepackage[table]{xcolor}                      % Para poder definir colores
...
\setlength{\arrayrulewidth}{0.5mm}              % Grosor de linea de la tabla
%\setlength{\tabcolsep}{9pt}                    % Ancho de cada celda
\renewcommand{\arraystretch}{1.3}               % Alto de cada celda
